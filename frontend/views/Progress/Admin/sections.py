...
from .studentslist import StudentsListWidget  # admin students list (same UI, same data)
from .studentprofile import StudentProfileWidget  # admin student profile (read-only view)


class SectionsWidget(QWidget):
    """
    Admin Progress page – displays all sections grouped by year level.
    Clicking 'View Students' opens the full StudentsListWidget for that section.
    """
    ...
    def __init__(self):
        ...
        # JSON watcher setup (we read the same faculty JSON files)
    ...
    def create_section_card(self, section):
        ...
        section_label.setFont(QFont("Poppins", 11, 75))
    ...
    def open_students_list(self, section_name):
        ...
        print(f"📖 Admin: Opening Students List for {section_name}")
    ...
    def show_sections_page(self):
        ...
        print("↩️ Admin: Returning to Sections page")
