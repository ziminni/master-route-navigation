...
from .studentprofile import StudentProfileWidget  # admin profile (read-only)


class StudentsListWidget(QWidget):
    """
    Admin: Displays the list of students in a specific section.
    Clicking a student's name or ID opens their profile (read-only).
    """

    def __init__(self, section_name, admin_name=None, go_back_callback=None, parent_stack=None):
        super().__init__()
        ...
        # Use the same faculty JSON file for student lists
    ...
    def populate_table(self):
        ...
        print(f"📘 Admin: Loaded {len(self.students_data)} students for {self.section_name}")
    ...
    def on_cell_clicked(self, row, column):
        ...
        print(f"👤 Admin: Opening profile for {student_id}")

        # Create Student Profile page (read-only)
    ...
    def on_file_changed(self, path):
        ...
        print(f"🔄 Admin: Detected change in {path}, reloading student list...")
        self.load_students_from_json()
