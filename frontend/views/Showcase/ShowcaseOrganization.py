...
# Competition form is imported lazily inside _on_competition
...
class TopBar(QFrame):
    ...
    def __init__(self, parent: QWidget | None = None):
        ...
        self.comp_btn = QPushButton("Competition")
        self.comp_btn.setProperty("role", "comp")
        plus = _icon("Plus 24px.png")
        if not plus.isNull():
            self.comp_btn.setIcon(plus)
...
class ShowcaseOrganizationPage(QWidget):
    ...
    def __init__(
        ...
        list_root = QWidget()
        lr = QVBoxLayout(list_root)
        lr.setContentsMargins(8, 8, 8, 8)
        lr.setSpacing(6)

        self.top = TopBar(list_root)
        ...
        self._form = None                # competition form (lazy)
    ...
    # ----- data -----
    def _reload(self):
        # Organization view: only approved items are visible
