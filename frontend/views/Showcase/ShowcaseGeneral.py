...
class LargeCard(QFrame):
    def __init__(self, payload: Dict, parent: QWidget | None = None):
        ...
        self.by_lbl = QLabel(f"by {by}" if by else ""); self.by_lbl.setProperty("role","by"); self.by_lbl.setVisible(bool(by))
...
class ShowcaseGeneralPage(QWidget):
    ...
    def __init__(self,
        ...
        self.cur_query = None
        self.data: Dict[str, List[Dict]] = {"project": [], "competition": []}            # filtered
        self.sidebar_source: Dict[str, List[Dict]] = {"project": [], "competition": []}  # unfiltered
        self._reload()
    ...
    def _populate_lists(self, kind: str):
        ...
        for idx, it in enumerate(items):
            ...
            def handler(e, i=idx, arr=items, orig=card.mouseReleaseEvent):
