...
try:
    from .AnnouncementFacultyReminder import AnnouncementFacultyReminderPage
except Exception:
    from AnnouncementFacultyReminder import AnnouncementFacultyReminderPage  # type: ignore
...
class AnnouncementFaculty(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.reminderList = QVBoxLayout(self.reminderHost); self.reminderList.setContentsMargins(0, 0, 0, 0)
        self.reminderList.setSpacing(10); self.reminderList.addStretch(1)
    ...
    def _open_add_reminder(self) -> None:
        page = AnnouncementFacultyReminderPage(parent=self)
