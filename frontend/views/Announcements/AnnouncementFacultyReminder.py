...
from PyQt6.QtWidgets import (
    ...
    QHBoxLayout, QVBoxLayout, QScrollArea, QFrame, QMessageBox,
...
# ---- theme ----
GREEN="#146c43"; TEXT="#1f2937"; BORDER="#e5e7eb"; WHITE="#ffffff"

CURRENT_USER_ID = 1  # replace when session is wired
...
# ---- widget ----
class AnnouncementFacultyReminderPage(QWidget):
    back_requested = pyqtSignal()
    request_close = pyqtSignal()
    submitted = pyqtSignal(int)  # reminder_id
    ...
    def _reset_form(self) -> None:
        ...
        self.txtNote.clear()
AnnouncementFacultyReminder = AnnouncementFacultyReminderPage

if __name__ == "__main__":
    ensure_bootstrap()
    app = QApplication(sys.argv)
    w = AnnouncementFacultyReminder()
    w.resize(1120, 720)
    w.show()
    sys.exit(app.exec())
