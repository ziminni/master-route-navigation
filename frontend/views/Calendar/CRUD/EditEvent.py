...
class EditEvent(QWidget):
    def __init__(self, username, roles, primary_role, token, event_data=None, parent=None):
        ...
        self.original_event_name = None

        # Reference to MainCalendar (set externally)
    ...
    def setup_event_form(self, form_layout):
        ...
        grid = QGridLayout(fields_container)
        grid.setSpacing(20)
        ...
        # Row 0: Title + Status
        row = 0
        lbl_title = QLabel("Event Title")
        lbl_title.setStyleSheet(label_style)
        grid.addWidget(lbl_title, row, 0, Qt.AlignmentFlag.AlignTop)
        ...
        grid.addWidget(self.input_event_title, row, 1)

        lbl_status = QLabel("Status")
        lbl_status.setStyleSheet(label_style)
        grid.addWidget(lbl_status, row, 2, Qt.AlignmentFlag.AlignTop)
        ...
        grid.addWidget(lbl_type, row, 0, Qt.AlignmentFlag.AlignTop)
        ...
        lbl_location = QLabel("Location/Venue")
        lbl_location.setStyleSheet(label_style)
        grid.addWidget(lbl_location, row, 2, Qt.AlignmentFlag.AlignTop)
        ...
        grid.addWidget(self.input_location, row, 3)

        # Row 2: Start date/time
        row = 2
        lbl_start_date = QLabel("Start Date")
        lbl_start_date.setStyleSheet(label_style)
        grid.addWidget(lbl_start_date, row, 0, Qt.AlignmentFlag.AlignTop)
        ...
        grid.addWidget(self.date_start, row, 1)

        lbl_start_time = QLabel("Start Time")
        lbl_start_time.setStyleSheet(label_style)
        grid.addWidget(lbl_start_time, row, 2, Qt.AlignmentFlag.AlignTop)
        ...
        grid.addWidget(start_time_widget, row, 3)

        # Row 3: End date/time
        row = 3
        lbl_end_date = QLabel("End Date")
        lbl_end_date.setStyleSheet(label_style)
        grid.addWidget(lbl_end_date, row, 0, Qt.AlignmentFlag.AlignTop)
        ...
        grid.addWidget(self.date_end, row, 1)

        lbl_end_time = QLabel("End Time")
        lbl_end_time.setStyleSheet(label_style)
        grid.addWidget(lbl_end_time, row, 2, Qt.AlignmentFlag.AlignTop)
        ...
        grid.addWidget(end_time_widget, row, 3)
    ...
    def load_event_data(self):
        ...
        idx_type = self.combo_event_type.findText(event_type)
        if idx_type >= 0:
            self.combo_event_type.setCurrentIndex(idx_type)
        ...
        idx_status = self.combo_status.findText(status)
        if idx_status >= 0:
